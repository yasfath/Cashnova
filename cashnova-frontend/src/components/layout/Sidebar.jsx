...
const navLinkClass = ({ isActive }) =>
  `theme-sidebar-link flex items-center justify-between rounded-2xl border border-transparent px-4 py-2.5 text-[13px] font-medium tracking-[-0.01em] transition-[background-color,border-color,color,box-shadow] ${
    isActive
  ...
  return (
    <div className="sidebar-content min-h-0">
      ...
      <div className="sidebar-nav space-y-4">
        <div>
          <p className="theme-sidebar-kicker mb-2.5 px-2 text-[10px] font-bold uppercase tracking-[0.2em]">
            Main Menu
          </p>

...
const sectionCardClass =
  "theme-card rounded-[20px] p-4 shadow-[0_18px_38px_rgba(19,52,72,0.08)]";
...
const RecommendationCard = ({ title, description, badge, icon: Icon, iconWrap, badgeStyle }) => {
  return (
    <div className="theme-panel rounded-[18px] p-3.5 shadow-[0_10px_24px_rgba(19,52,72,0.055)] transition duration-200 hover:-translate-y-[2px] hover:shadow-[0_16px_30px_rgba(19,52,72,0.09)]">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1.5 text-[11px] leading-5 text-[#647c8a]">{description}</p>
          <span className={`mt-2 inline-flex rounded-full px-2.5 py-1 text-[10px] font-semibold ${badgeStyle}`}>
            {badge}
          </span>
        </div>
      </div>
...
const CategoryBar = ({ label, value, status, bar, text }) => {
  return (
    <div className="space-y-1.5">
      ...
      <div className="h-2 overflow-hidden rounded-full bg-[rgba(207,221,228,0.65)]">
        <div
          className="h-2 rounded-full shadow-[0_8px_18px_rgba(19,52,72,0.12)] transition-all duration-300"
          style={{
...
const AIInsights = () => {
  ...
  return (
    <PageContainer>
      <div className="ai-insights-page grid grid-cols-1 gap-3 px-4 pb-4 pt-3 sm:px-5 xl:grid-cols-[minmax(0,1.04fr)_minmax(0,1fr)] xl:px-6">
        <section>
          <div className={sectionCardClass}>
            <div className="mb-3">
              ...
              <h3 className="mt-1.5 text-[19px] font-bold tracking-[-0.03em] text-[#12303f]">
                AI Recommendations
              </h3>
            </div>
          ...
          <div className={sectionCardClass}>
            <div className="mb-2 flex flex-wrap items-center justify-between gap-2">
              <div>
                ...
                <h3 className="mt-1.5 text-[18px] font-bold tracking-[-0.03em] text-[#12303f]">
                  Spending Pattern Analysis
                </h3>
                <p className="mt-0.5 text-[11px] text-[#647c8a]">
            ...
            <div className="theme-panel relative h-[210px] rounded-[18px] p-2.5">
              <ResponsiveContainer width="100%" height="100%">
                <RadarChart data={insightState.spendingPatternData} outerRadius="62%">
            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-2">
              <div className="theme-panel rounded-[16px] px-3 py-2.5">
                <p className="text-[10px] font-semibold uppercase tracking-[0.18em] text-[#6f8795]">
                  Current Spend
                </p>
                <p className="mt-1 text-[20px] font-bold text-[#12303f]">
